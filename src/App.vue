...
import IconFilterXMark from '@/components/icons/IconFilterXMark.vue';
            ...
            <div class="max-w-screen-2xl mx-auto px-5 sm:px-10 md:px-16 2xl:px-28">
              <div class="lg:flex justify-between items-center max-w-screen-2xl lg:px-16 mx-auto">
                ...
                <Transition name="slide-y">
                  <div v-show="isVisible" class="pt-2 flex justify-start items-center gap-1">
                    <Search class="grow" />
                    <button 
                    ...
                    >
                      <span class="flex justify-center items-center gap-2">
                        <IconFilterXMark :style="{ color: device.style.color }" />
                        Reset
                      </span>
                    </button>
                  </div>
