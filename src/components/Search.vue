...
<template>
  <div class="flex justify-center items-center">
    <div @click="toggleSearch = !toggleSearch" class="search-icon cursor-pointer bg-stone-400 hover:bg-stone-500 text-white px-2 py-2 rounded-full relative z-10 shadow-md">
