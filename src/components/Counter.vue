  ...
  <div class="mx-auto inset-x-0 fixed bottom-0 sm:mb-2 z-[800] w-full sm:w-[450px] cursor-pointer">
    ...
    <div class="relative max-w-lg mx-auto bg-stone-800">
      ...
      <div class="flex items-center justify-between font-semibold">
        <div @click="modalStore.openMenu(Device)" class="flex-1 flex justify-center items-center py-4 hover:bg-stone-700">
        ...
        <div @click="modalStore.openMenu(SelectedGames)" class="flex-1 flex justify-center items-center py-4 hover:bg-stone-700">
        ...
        <div @click="modalStore.openMenu(Products)" class="flex-1 flex justify-center items-center py-4 hover:bg-stone-700">
