  ...
  <SelectedList>
    <template #header>
      <div class="flex items-center">
        ...
        <h2 class="text-md ml-3 text-stone-300 uppercase font-semibold">{{ device.unit }} List</h2>
      </div>
      <p class="text-sm text-stone-200 ml-1 pt-2">Games compatibility is buyers responsibility</p>
    </template>
