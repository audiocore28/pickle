    ...
    <table class="w-full rounded-xl">
      <tbody>
        <tr v-for="accessory in device.assignedAccessories" class="text-center border-b border-stone-700">
          ...
          <td class="w-[100px]">
            <div class="py-1 px-2 bg-stone-700 rounded-[10px] border border-stone-500 justify-around items-center flex">
              <svg @click="productStore.decrementQty(accessory)" width="14" height="15" class="cursor-pointer" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.33398 7.5H11.6673" stroke="#78716c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
              ...
              <svg @click="productStore.incrementQty(accessory)" class="cursor-pointer relative" width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.33398 7.49998H11.6673M7.00065 2.83331V12.1666V2.83331Z" stroke="#78716c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </div>
          </td>
